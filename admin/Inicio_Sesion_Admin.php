...
if(isset($_POST['submit'])){
   ...
   $select_admin = $conexion->prepare("SELECT * FROM `admins` WHERE name = ? AND password = ?");
...
<head>
   ...
   <title>Sesión de Aministrador - Vende@Cañete</title>
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <p>User Vende@Cañete = <span>admin</span> & Contraseña = <span>111</span></p>
      <input type="text" name="name" required placeholder="Ingrese el Nombre del Usuario" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
